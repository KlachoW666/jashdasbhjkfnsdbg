...
export const translations = {
    ru: {
        ...
        home: {
            ...
            wevoxTitle: 'Монета WEVOX',
            wevoxDesc: 'Обменивайте заработанный USDT на WEVOX в разделе «Обмен». После листинга токены будут выданы на ваш счёт.',
            listingCountdown: 'До листинга',
            daysShort: 'д',
            hoursShort: 'ч',
            minsShort: 'м',
            secsShort: 'с',
            wevoxPriceLabel: 'Текущая цена',
            zyphexTitle: 'Монета WEVOX',
            zyphexDesc: 'Обменивайте заработанный USDT на WEVOX в разделе «Обмен». После листинга токены будут выданы на ваш счёт.',
        ...
        exchange: {
            title: 'Обмен USDT → WEVOX',
            rateLabel: 'Курс',
            rateDesc: '1 USDT =',
            pricePerCoin: 'Цена 1 WEVOX',
            poolRemainingFormat: 'В пуле: X из Y WEVOX',
            availableUsdt: 'Доступно USDT',
            amountToExchange: 'Сумма к обмену (USDT)',
            youGet: 'Получите',
            exchangeBtn: 'Обменять',
            yourZyphex: 'Ваш баланс WEVOX',
            balanceInUsdAtRate: 'по текущему курсу',
    ...
    en: {
        ...
        home: {
            ...
            wevoxTitle: 'WEVOX Token',
            wevoxDesc: 'Exchange your earned USDT for WEVOX in the Exchange section. After listing, tokens will be credited to your account.',
            listingCountdown: 'Until listing',
            daysShort: 'd',
            hoursShort: 'h',
            minsShort: 'm',
            secsShort: 's',
            wevoxPriceLabel: 'Current price',
            zyphexTitle: 'WEVOX Token',
            zyphexDesc: 'Exchange your earned USDT for WEVOX in the Exchange section. After listing, tokens will be credited to your account.',
        ...
        exchange: {
            title: 'Exchange USDT → WEVOX',
            rateLabel: 'Rate',
            rateDesc: '1 USDT =',
            pricePerCoin: 'Price per 1 WEVOX',
            poolRemainingFormat: 'In pool: X of Y WEVOX',
            availableUsdt: 'Available USDT',
            amountToExchange: 'Amount to exchange (USDT)',
            youGet: 'You get',
            exchangeBtn: 'Exchange',
            yourZyphex: 'Your WEVOX balance',
            balanceInUsdAtRate: 'at current rate',
