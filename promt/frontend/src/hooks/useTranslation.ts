...
export const translations = {
    ru: {
        ...
        home: {
            ...
            wevoxTitle: 'Монета ZYPHEX',
            wevoxDesc: 'Обменивайте заработанный USDT на ZYPHEX в разделе «Обмен». После листинга токены будут выданы на ваш счёт.',
        ...
        exchange: {
            ...
            promoErrorSupply: 'В пуле недостаточно ZYPHEX для промо'
        },
        referral: {
    ...
    en: {
        ...
        home: {
            ...
            wevoxTitle: 'ZYPHEX Token',
            wevoxDesc: 'Exchange your earned USDT for ZYPHEX in the Exchange section. After listing, tokens will be credited to your account.',
        ...
        exchange: {
            ...
            promoErrorSupply: 'Not enough ZYPHEX in pool for promo'
        },
        referral: {
